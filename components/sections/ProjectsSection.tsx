    ...
    <section id="projects" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`bg-card border ${project.color} rounded-2xl p-6 hover:shadow-2xl hover:shadow-spider-red/20 transition-all duration-300 group`}
            >
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  <div className={`p-3 rounded-lg bg-background ${project.textColor}`}>
                    <project.icon size={24} />
                  </div>
                  <h3 className="text-2xl font-bold text-foreground">{project.title}</h3>
                </div>
                <div className="flex space-x-2">
                  <a href={project.github} className="p-2 rounded-lg bg-background text-muted-foreground hover:text-foreground hover:bg-card">
                    <Github size={18} />
                  </a>
                  <a href={project.demo} className="p-2 rounded-lg bg-background text-muted-foreground hover:text-foreground hover:bg-card">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-background text-card-foreground rounded-full text-sm border border-border"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="text-center mt-12">
          <motion.a
            href="#"
            className="inline-flex items-center px-6 py-3 border border-border text-muted-foreground rounded-lg hover:border-spider-red hover:text-spider-red transition-colors"
